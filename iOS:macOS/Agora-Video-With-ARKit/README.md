...
1. Open `Agora-Video-With-ARKit.xcodeproj` and update "KeyCenter.swift" with your App ID.

```
static let AppId: String = "Your App ID"
```

2. Download the [Agora Video SDK](https://docs.agora.io/en/Agora%20Platform/downloads). Unzip the downloaded SDK package and copy the `libs/AograRtcKit.framework` file into the `../libs` folder.
