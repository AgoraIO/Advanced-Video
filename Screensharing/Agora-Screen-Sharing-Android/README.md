...
The Agora Screen Sharing for Android Sample App is an open-source demo that shows how to enable screen sharing function using the Agora Video SDK. This sample also shows how to start both camera view and screen share view in one application. This is achieved by making screen share as a standalone service. For the detailed design, please refer to the screen_share_service.png file under the project root folder.
