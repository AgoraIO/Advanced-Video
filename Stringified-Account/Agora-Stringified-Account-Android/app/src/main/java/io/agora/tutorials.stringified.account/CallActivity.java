...
public class CallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocal.userAccount = getIntent().getStringExtra(BuildConfig.KEY_STRINGIFIED_ACCOUNT);
    ...
    private void initializeAgoraEngine() {
        try {
            ...
            mRtcEngine.registerLocalUserAccount(appId, mLocal.userAccount); // Better to call it before joinChannel, it will accelerate speed of the process when join channel with stringified account
        } catch (Exception e) {
