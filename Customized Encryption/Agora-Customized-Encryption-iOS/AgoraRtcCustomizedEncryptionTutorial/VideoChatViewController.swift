...
class VideoChatViewController: UIViewController {
    ...
    func initializeAgoraEngine() {
        ...
        AgoraPacketProcessing.register(agoraKit)
    }

    // Tutorial Step 2
    func setupVideo() {
        agoraKit.enableVideo()  // Default mode is disableVideo
        agoraKit.setVideoProfile(.landscape720P, swapWidthAndHeight: false) // Default video profile is 360P
    }
    ...
    func leaveChannel() {
        agoraKit.leaveChannel { [weak self] _ in
            AgoraPacketProcessing.deregister(self?.agoraKit)
