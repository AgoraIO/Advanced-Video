...
public:
	...
	BOOL JoinChannelWithUserAccount(LPCTSTR channelId, LPCTSTR userAccount, LPCTSTR token = NULL);
	BOOL RegisterLocalUserAccount(LPCTSTR strAppId, LPCTSTR userAccount);
