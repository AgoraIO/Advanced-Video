...
typedef struct _AGE_LOCAL_USER_REGISTER
{
	char	userAccount[256];
	uid_t   uid;

}AGE_LOCAL_USER_REGISTER, *PAGE_LOCAL_USER_REGISTER, *LPAGE_LOCAL_USER_REGISTER;

#define EID_LOCAL_USER_REGISTER					0x00000021


typedef struct _AGE_USER_INFO_UPDATE
{
	uid_t uid;
	char	userAccount[256];

}AGE_USER_INFO_UPDATE, *PAGE_USER_INFO_UPDATE, *LPAGE_USER_INFO_UPDATE;

#define EID_USER_INFO_UPDATE					0x00000022
