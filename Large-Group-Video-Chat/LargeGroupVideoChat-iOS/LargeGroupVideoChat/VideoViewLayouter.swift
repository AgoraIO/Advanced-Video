...
private extension VideoViewLayouter {
    func setSmallViews(_ smallViews: inout [UIView], maxTo count: Int) {
    ...
    func layout(fullView: UIView) -> [NSLayoutConstraint] {
    ...
    func layouts(ofSmallViews smallViews: [UIView], fullView: UIView, countPerLine: Int, edgePosition: EdgePosition) -> [NSLayoutConstraint] {
