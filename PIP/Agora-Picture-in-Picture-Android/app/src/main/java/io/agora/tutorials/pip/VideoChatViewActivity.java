package io.agora.tutorials.pip;
...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    public void onPause() {
        ...
        // If called while in PIP mode, do not pause video stream
        if (isInPictureInPictureMode()) {
            // Continue playback
        } else {
            // Use existing video stream logic for paused Activity behavior.
        }
    }
    ...
    public void onResume() {
        ...
        // If called while in PIP mode, you need to to nothing
        if (isInPictureInPictureMode()) {
            // Continue playback
        } else {
            // Use existing video stream logic for resumed Activity behavior.
        }
    }
...
//      mRtcEngine.setVideoProfile(Constants.VIDEO_PROFILE_360P, false); // Earlier than 2.3.0
    ...
    private void joinChannel() {
        mRtcEngine.joinChannel(null, "pipChannel1", "Extra Optional Data", 0); // if you do not specify the uid, we will generate the uid for you
    }
