...
public:
    ...
    {
        videoRender->setWindowTitle(QApplication::translate("videoRender", "AgoraVideoCall", 0));
        openVideoFile->setText(QApplication::translate("videoRender", "Open", 0));
        pushStream->setText(QApplication::translate("videoRender", "publish", 0));
        pauseBtn->setText(QApplication::translate("videoRender", "Play", 0));
        audioMix->setText(QApplication::translate("videoRender", "isAudioMix", 0));
        quitBtn->setText(QApplication::translate("videoRender", "Quit", 0));
    } // retranslateUi
