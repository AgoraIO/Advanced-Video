...
namespace AgoraAPM {
  template <class T, class D = AgoraExternalResampler::DefaultDeleter<T> >
  class scoped_ptr {
...
//        : impl_(&other.impl_) {
//            // static_assert(!AgoraExternalResampler::is_array<U>::value, "U cannot be an array");
//        }
//
...
//        }
  ...
  private:
    typedef AgoraExternalResampler::internal::scoped_ptr_impl<element_type, deleter_type>
    scoped_ptr::*Testable;
  ...
  private:
    ...
    AgoraExternalResampler::internal::scoped_ptr_impl<element_type, deleter_type> impl_;
